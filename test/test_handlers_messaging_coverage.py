...
class TestApiSpawnDelete:
    ...
    def test_delete_scopes_settlement_to_the_deleted_runs_owner(self, monkeypatch) -> None:
        ...
        assert info_b.id in sibling_bucket
        marker = sibling_bucket[_REPORT_FAILURE_OVERFLOW_MARKER_ID]
        assert marker.parent_session_key == parent
        assert marker.boundary_owner == owner_b
        ...
        manager.settle_before_delete.assert_awaited_once_with(info_a.id, "")
