...
class TestWorktreeProbeFailureClassifier:
    ...
    def test_whitespace_only_git_dir_is_a_path_not_a_blank(self, git, tmp_path):
        ...
        unlocatable. (Win32 strips trailing spaces from names, so the
        fixture dir is uncreatable there; the platform-neutral terminator
        coverage lives in ``test_git_worktree_scope.py``.)"""
        weird = tmp_path / "  "
        weird.mkdir()
