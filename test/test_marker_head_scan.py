...
class TestRfindMarkerHead:
    ...
    def test_an_extra_literal_is_matched_case_sensitively(self):
        assert rfind_marker_head("[STEERING x", "[STEERING") == 0
        assert rfind_marker_head("[steering x", "[STEERING") == -1
