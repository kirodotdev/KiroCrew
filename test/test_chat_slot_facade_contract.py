...
_TO_DICT_KEYS = (
    ...
    # beside model — same facade contract, one new key — and the flag that says
    # the pick could not be READ at restore (null for lack of an answer, not
    # because the chat inherits) rides beside it.
    "acp_backend",
