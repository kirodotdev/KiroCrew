...
@pytest.mark.parametrize(
    ...
    (
        ...
        # both in-sandbox, and an EMPTY bind over either ABORTS composition -- so
        # hiding a ceiling does not loosen it, it stops the process booting at all.
        "security_policy.json",
        "admission_policy.json",
        "profiles",
        "app_admission.json",
        # Opt-out and consent ceilings the config loader reads in-sandbox.
...
# ── The other half of the ruling: five leaves the child is DENIED ─────────────
#
