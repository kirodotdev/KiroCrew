...
async def test_add_preserves_only_authenticated_composer_text(
    ...
    monkeypatch.setattr(autonudge_authz, "record_scheduled_message", lambda _i, _s, _m, _a: None)
...
async def test_scheduled_provenance_binds_content_refreshes_and_rolls_back(
    ...
    monkeypatch.setattr(
        ...
        lambda record_id, bound_slot, message, at: recorded.append(
            (record_id, bound_slot, message, at)
        ),
    )
    monkeypatch.setattr(
        autonudge_authz,
