...
subprocess boundary is mocked: these are injected-env unit tests, not a live
host.
...
def test_wsl2_distro_choices_filters_docker_desktop(monkeypatch):
    """A real host with one general-purpose distro plus Docker Desktop's own
    WSL2 utility instances, which are not meant to run arbitrary
    workloads."""
