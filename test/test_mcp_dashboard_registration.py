...
class TestWhatThisSetGrants:
    ...
    #: read, create, and assign; no delete and no rename — so the same
    #: assignment grants it: an agent told to organize sessions files them AND
    #: labels them, and a label is the smaller of the two writes (a folder move
    #: changes what the person sees where; a tag adds a chip).
    TAG_TOOLS = {
        "chat_tag_list",
        "chat_tag_create",
        "chat_tag_assign",
