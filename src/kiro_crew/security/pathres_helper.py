...
``{"i": <int>, "r": [<realpath>|null, ...]}`` in order -- ONE spelling, because anchors
use ``realpath`` alone and on Windows each spelling is a handle open per path
component. The list
    ...
    for raw in stdin:
        try:
            ...
            if isinstance(paths, str):
                ...
                # An anchor batch: one spelling (see the module docstring).
