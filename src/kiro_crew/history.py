...
def reconcile_ctx_overflow(
    ...
    try:
        ...
        # Returning would leave a stale sidecar re-injecting delivered context; quarantine
        # instead. Reused when the raiser already moved it: clearing an empty stem does nothing.
        cleared = (
