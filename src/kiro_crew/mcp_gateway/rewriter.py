...
# 8: a reserved kirocrew-* entry launches the managed invocation, not the
...
# (Schema 9 on ``main``, where 8 is the registry-governed/muted pass-through
# that this release branch does not carry.)
