...
class _Base(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        routes._CANCELLED_NS.clear()
        routes._CONSOLIDATE_STATE.clear()
        # Consolidation is gated on the app being enabled, the same way starting
        # a review is. These cases are about what an ENABLED app merges, so they
