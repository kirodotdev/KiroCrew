...
from kiro_crew.effort import is_valid_effort, model_supports_effort, select_effort_level
    ...
    async def _apply_effort(self) -> None:
        ...
        try:
            ...
            if not via_config_option:
                ...
                # neither warns per spawn nor sends a doomed command. The
                # config-option backends keep their own supports_config_option
                # gate above.
