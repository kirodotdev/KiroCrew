        ...
        try:
            ...
            try:
                ...
                if not dashboard_restricted:
                    # BOTH sinks take the scrubbed body: the projection broadcasts and
                    # marks the slot dirty, so a persist-side scrub alone is too late.
                    safe_text = redact_row_via_context(text)
