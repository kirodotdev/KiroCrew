...
def _resolve_repo(
    ...
    *,
    ...
    # The lookup carries the CURRENT declaration: a checkout whose provenance
    # record names another remote or branch (a sync repointed the source after
    # activation) is unavailable here, never silently served.
