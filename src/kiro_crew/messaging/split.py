...
def repaired_for_delivery(
    ...
    The returned text is safe to cut AGAIN by any rule the caller likes, because
    ...
    rendering assembles -- the answer is the canonical form of the source, which
    ...
    if repaired is not None:
        return repaired
    return redact_for_display(canonicalize_display(source), redactor)[0]
