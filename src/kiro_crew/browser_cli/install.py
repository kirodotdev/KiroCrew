...
# The verified listener fixture is
# ``Listening on http://127.0.0.1:45613``. ``@latest`` may change that wording;
# the parser then fails closed and reports the installed version for diagnosis.
