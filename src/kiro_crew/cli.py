...
""",
    ...
    # ── Crew-to-crew work migration: the task-run move verb ──
    ...
    # that keeps the top-level help from drifting. This was first added with a raw
    # add_parser and so bypassed it -- caught only by the full suite's drift test,
    # not by any migration test.
