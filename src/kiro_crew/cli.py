...
_LONG_LIVED_COMMANDS = {"serve", "gateway", "chat", "acp", None}
...
""",
    ...
    acp_parser.add_argument(
        "--gateway-url",
        help=(
            "Gateway base URL (default: loopback KIROCREW_PORT; use https and set "
            "KIROCREW_GATEWAY_TOKEN for non-loopback URLs)"
        ),
    )
