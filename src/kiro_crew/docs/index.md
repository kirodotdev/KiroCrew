...
| [Session Control](session-control.md) | Let one chat session open, fork, seed, watch, stop, close and revive another one — the 18 `kirocrew-dashboard` MCP tools, plus the sidebar folders and tags that keep them findable |
