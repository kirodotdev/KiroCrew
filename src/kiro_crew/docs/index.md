...
| [Session Control](session-control.md) | Let one chat session open, seed, watch, stop and close another one — the 16 `kirocrew-dashboard` MCP tools, plus the sidebar folders and tags that keep them findable |
