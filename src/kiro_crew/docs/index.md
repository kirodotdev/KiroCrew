...
| [Session Control](session-control.md) | Let one chat session open, fork, seed, watch, broadcast to, stop and close another one — the 19 `kirocrew-dashboard` MCP tools, plus the sidebar folders and tags that keep them findable |
