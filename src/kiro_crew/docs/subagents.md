...
shows a localized “Used … credits” summary when you expand a card with positive
reported credits. When credits are not reported, the dashboard identifies that
state in the expanded card body. Elapsed time rounds to whole seconds before
