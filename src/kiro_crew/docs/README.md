...
| [decisions.md](decisions.md) | Jev skill selection: letting a small fast model pick the automatic skill for a sampled conversation, with trigger matching as the fallback and a basic diagnostic log. |
