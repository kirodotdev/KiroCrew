...
class DashboardState:
    ...
    def get_or_create_slot(
        ...
        *linked_session_key* binds a new slot to the session its conversation
        ...
        # A new slot on a recycled key inherits nothing: `remove` preserves the previous
        # slot's retirement arm by design, and with no manager there is no arm to supersede.
        if self.sessions:
