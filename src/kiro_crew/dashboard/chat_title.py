...
# Short numbers (PR #7353, "port 8080") stay below the bar on purpose — a title
# that NAMES a small number is usually describing its topic, not echoing a key.
...
async def maybe_refresh_title(state: DashboardState, slot: _ChatSlot) -> None:
    ...
    - Each milestone fires at most ONCE, attempt-counted: a KEEP/SKIP/prose
      ...
      whose title locked as a URL/ticket-key echo (see ``_is_low_signal_title``).
