...
def subagents_attached(
    ...
    *,
    ...
    if running is None:
        detail = "child-work status unavailable"
    elif running:
        detail = "running child work"
    elif queued_probe_failed:
        detail = "queued-child status unavailable"
    elif queued:
        detail = "queued child work"
    elif terminal_delivery_probe_failed:
        detail = "terminal-report status unavailable"
    elif terminal_delivery:
        detail = "terminal child report delivery"
    elif slot_delivery:
        detail = "completion handoff in progress"
    elif accepted_completion:
        detail = "completion awaiting parent consumption"
    elif retained_failure:
        detail = "completion delivery retry"
    else:
        detail = ""
...
def subagent_attachment_detail(
    ...
    """Return the bounded holding probe from the shared attachment evaluation."""
    detail: list[str] = []
