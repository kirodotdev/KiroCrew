        ...
        rows.append(
            {
                ...
                # tests it against ``row["name"]``, and a surviving row's name
                # is redactor-clean, so a masked owner compares unequal
                # exactly as the raw suspicious value does (fail-closed).
