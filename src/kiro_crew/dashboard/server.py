...
async def start_dashboard(
    ...
    app.router.add_post("/api/agents/installed", handlers.api_agents_installed_create)
    app.router.add_put("/api/agents/installed/{name}", handlers.api_agents_installed_update)
