...
async def start_dashboard(
    ...
    app.router.add_patch("/api/chat/slots/{slot}/plan-mode", chat.api_chat_slot_plan_mode)
    app.router.add_post("/api/chat/slots/{slot}/plan-approve", chat.api_chat_plan_approve)
