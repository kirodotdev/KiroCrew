    ...
    *,
    ...
    def _queue_recovery(
        ...
        *,
        ...
        recovery_meta = containment_meta(state, slot)
        if payload == RecoveryPayload.ORIGINAL and isinstance(_current_replay_message, dict):
            ...
            recovery_meta.update(attachment_meta(_current_replay_message.get("meta")))
        ...
        return slot.queue_insert(
            ...
            # recovery, no kind that names a producer. Layered onto recovery_meta
            # so the ORIGINAL-replay attachment lists above are preserved too.
            meta={**recovery_meta, TURN_ACTOR_META_KEY: _ledger_actor},
