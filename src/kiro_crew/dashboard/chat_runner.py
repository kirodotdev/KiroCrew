            ...
            if (
                ...
                slot.append(
                    ...
                    + (
                        ...
                        if _binding_rebound and not (_binding_superseded or _binding_stopped)
                        else (
                            "your newer message runs instead."
                            if _binding_superseded
    ...
    if _is_binding_retry_turn:
        ...
        if (
            ...
            slot.append(
                ...
                + (
                    "this chat moved to another session."
                    if _bv_rebound and not (_bv_superseded or _bv_stopped)
                    else (
                        "your newer message runs instead."
                        if _bv_superseded
                        else "the turn was stopped."
        ...
        if _is_binding_retry_turn:
            ...
            if _binding_pre_rebound or _binding_pre_superseded:
                ...
                slot.append(
                    ...
                    + (
                        "this chat moved to another session."
                        if _binding_pre_rebound and not _binding_pre_superseded
                        else "your newer message runs instead."
                    ),
                    "msg msg-info",
                )
                logger.info(
