                ...
                "properties": {
                    "label": {
                        ...
                        "description": (
                            ...
                            'renders it as "End of section: <label>", so write '
                            "the bare id and let the row supply the direction — "
                            'do not write "End of" yourself. Max 120 chars. Omit '
                            'to draw a generic "End of section" rule instead.'
                        ),
                    },
                },
            },
