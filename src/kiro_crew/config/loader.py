...
class KiroCrewConfig:
    ...
    def _load_resolved(cls) -> tuple[KiroCrewConfig, int, str | None]:
        ...
        if cached is not None:
            ...
            # say which content it represents. Withheld when either file could not be
            # read or parsed whole, because the object then carries field defaults
            # rather than any one set of bytes.
