...
def _build_skills_config(skills_data: dict) -> SkillsConfig:
    ...
    return SkillsConfig(
        ...
        lazy_load=bool(skills_data.get("lazy_load", d.lazy_load)),
        auto_create_from_sessions=bool(
            skills_data.get("auto_create_from_sessions", d.auto_create_from_sessions)
        ),
        auto_refine_on_deviation=bool(
        ...
        approval_required=bool(skills_data.get("approval_required", d.approval_required)),
        ...
        generate_scripts=bool(skills_data.get("generate_scripts", d.generate_scripts)),
