...
class SessionManager:
    ...
    def supersede_arm_for_new_slot(self, key: str, *, only_generation: int | None = None) -> None:
        ...
        ``only_generation`` makes this a retraction of ONE arm: pass the generation the
        allocation boundary's ``mark_retire_on_next_claim`` returned, and a key another
        producer has armed since is left alone.
        """
