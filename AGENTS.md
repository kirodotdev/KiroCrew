...
| `connections/vendors/asana/`, the Asana connector's vendor-protocol logic (field rules, pagination, error classification, create/readback, MCP-vs-REST auth) | [connector-asana](docs/system-specs/modules/connector-asana.md) |
