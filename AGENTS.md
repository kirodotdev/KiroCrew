...
| `connections/vendors/salesforce/` — Salesforce describe model, typed payload parsing, error classification, query-locator/bulk contracts, Apex gate | [connector-salesforce-core](docs/system-specs/modules/connector-salesforce-core.md) |
