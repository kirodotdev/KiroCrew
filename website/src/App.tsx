...
export default function App() {
  ...
  useKeyboardShortcuts({ onToggleShortcutsModal: toggleShortcutsModal, onNewChat: () => newChatMutation.mutate(), disabled: shortcutsOpen,
    ...
    onToggleTerminal: terminalEnabled && !isPopout && !isEmbed
      ? () => { if (terminalPoppedOut) focusTerminalPopout(terminalSessionScope); else toggleTerminalByChord(activeSlotProject, terminalSessionScope) }
      : undefined,
  })
            ...
            <div className="shrink-0 grid gap-0.5 px-2 pt-1 pb-2">
              ...
              {terminalEnabled && (
                <NavItem
                  ...
                  onClickOverride={() => { if (terminalPoppedOut) focusTerminalPopout(terminalSessionScope); else toggleBottomTerminal(activeSlotProject, terminalSessionScope) }}
                />
              )}
              {hasRenderableMobileConnect && (
                <NavItem
