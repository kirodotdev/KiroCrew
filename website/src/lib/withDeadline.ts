 ...
 * past that set; a general bound belongs in the shared transport instead, and when one
 * lands these constants are RETIRED, never left layered over it as a second deadline.
 */
