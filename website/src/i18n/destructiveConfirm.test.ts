...
export const QUOTED_OPERAND_CONFIRM_KEYS = [
  // The operand is a SESSION TITLE, so an ordinary-word title would read as prose.
  'pages.chatSidebar.cleanup_unsent_confirm', // session-title operand, quoted per locale
