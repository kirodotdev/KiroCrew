...
/**
 * A UNC prefix — ANY two leading separators, of either kind and in either
 * order (`\\host`, `//host`, `\/host`, `/\host`), the shape Windows reads as
 * a UNC root in all four spellings.
 *
