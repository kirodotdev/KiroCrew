 ...
 *
 *  It has to be, because the timeout path offers recovery: a bound under the honest walk
 *  time fails every attempt alike. Driving the shipped handler with no ready index
 *  measured 1.3-2.0s across five samples but one at 5.4s, every figure a lower bound
 *  (the harness had warmed the cache), so a 5s bound cut off walks that would have answered.
 *
