 ...
 *
 * The backend keeps its OPTIONS-family patterns to ONE definition site, so a consumer over
 * there cannot spell its own. The frontend had no equivalent guard, and the gap was not
 * theoretical: three consumers
