 ...
 *  - the ASSISTANT ROW. The backend field does not exist on `main` yet, so the
 *    absent-field path is the shipping path: the row must render exactly as it
 *    does today, and the strip must appear when the field arrives.
 */
