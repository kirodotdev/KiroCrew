/**
 * A Project-attached session whose Project list cannot be read must surface
...
describe('ChatPage — Project list read failure on a Project-attached session', { timeout: 15_000 }, () => {
