...
const SKIP_REASON =
  "Agent 'default' is defined in project directory '/repo' and would shadow " +
  "this job's Crew Member, so the run was skipped rather than started under " +
  "the member's own private memory. Rename the project's agent or unbind the member."
