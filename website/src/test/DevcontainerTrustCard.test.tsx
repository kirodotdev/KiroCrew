...
describe('DevcontainerTrustCard', () => {
  ...
  it('names the consequence: not a sandbox, setup commands run, mounts are granted', () => {
    setup()
    ...
    expect(screen.getByText(/host mounts and run arguments it declares/i)).toBeInTheDocument()
