...
function AgentIdentitySection() {
  ...
  // moment either changes -- including a return to a URL previewed earlier,
  // whose targets may have changed since -- so the commit never restates a
  // stale grant. The equality check below is the second line: a response that
  // lands for a request the draft has already moved past is ignored.
