...
describe('SecretsPanel', () => {
  ...
  it('lists stored secret names with values masked', async () => {
    ...
    expect(screen.getByText(/Reference one as secret:\/\/YOUR_KEY in an MCP server env or a \.env setting/)).toBeInTheDocument()
...
describe('SecretsPanel custom secrets card', () => {
  it('always renders the Custom secrets card with the MCP disclaimer, even when empty', async () => {
    ...
    expect(screen.getByText(/in an MCP server env or a \.env setting/)).toBeInTheDocument()
