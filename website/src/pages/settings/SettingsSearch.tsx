    ...
    <div ref={rootRef} className="relative shrink-0">
      ...
      <input
        ...
        className={floating
          ...
          : inNav
          ? 'w-full bg-bg-elevated border border-border rounded-lg pl-8 pr-3 py-1.5 text-[13px] text-text placeholder:text-muted focus:outline-none focus-visible:border-accent'
