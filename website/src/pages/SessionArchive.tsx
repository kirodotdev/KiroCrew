    ...
    <div className="flex gap-4 h-full text-sm">
      <div className="w-1/3 flex flex-col border border-border rounded p-2 overflow-hidden">
        <div className="flex gap-2 mb-2">
          {/* min-w-0: an <input> defaults to `min-width: auto`, so as a flex item
              it refuses to shrink below its intrinsic ~20-character width. The
              row would overflow instead of the input yielding, and the pane is
              overflow-hidden — so the Reload button beside it is clipped away
              entirely rather than the row becoming scrollable. */}
