 ...
 // composer instead of auto-submitting. Auto-submitting would be a
  ...
  useEffect(() => {
    ...
    if (feed.open) {
      ...
      try {
        setSessionScopedItem(localStorage, `mc-webpreview-applied:${slot}`, norm)
      } catch { /* ignore */ }
