  ...
  return (
    ...
    >
      {tab => <>
        ...
        {tab !== 'overview' && tab !== 'chat' && tab !== 'voice' && tab !== 'display' && tab !== 'browser' && tab !== 'instances' && tab !== 'security' && tab !== 'notifications' && tab !== 'slack' && tab !== 'discord' && tab !== 'shortcuts' && tab !== 'developer' && tab !== 'about' && (
