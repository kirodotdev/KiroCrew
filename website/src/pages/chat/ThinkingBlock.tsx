  ...
  return (
    <div className="self-start w-full">
      ...
      <button
        ...
        className={`${tail ? 'flex w-full min-w-0' : 'inline-flex'} ${ROW_PILL_BUTTON_CLASS} text-muted hover:text-text cursor-pointer bg-transparent border-none focus:outline-none focus-visible:ring-1 focus-visible:ring-accent`}
      ...
      <AnimatePresence initial={false}>
        {expanded && (
          ...
          >
            ...
            <div className="mt-1 mb-2 border-l-2 pl-3 border-l-[color-mix(in_srgb,var(--accent)_70%,transparent)]">
