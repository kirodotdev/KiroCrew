...
interface KiroCrewCfg {
  ...
  agent: { default_agent: string; provider: string; model: string; approval_mode: string; sandbox: string; sandbox_wsl_distro?: string; subagent_max_turns?: number; max_subagents?: number; subagent_auto_max?: number; tool_search?: boolean; max_channels: number; max_channel_agents: number }
