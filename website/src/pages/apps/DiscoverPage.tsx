  ...
  return (
    <>
      ...
      {/* `scrollbar-gutter: stable` reserves the vertical scrollbar's width even
          when no scrollbar shows, so the centered, width-capped content column
          below does not slide horizontally when the app count crosses the
          overflow threshold (e.g. 25 apps → 5 apps drops the scrollbar). Same
          fix the chat transcript uses (TranscriptScrollShell). */}
