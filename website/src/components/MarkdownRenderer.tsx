 ...
 *  2. CJK punctuation IMMEDIATELY followed by a BACKTICK. That is the
 *     destructive case (the run eats an opening code-span delimiter and shifts
 *     every later pairing) and the one character that cannot appear in a
 *     raw-written URL. `…/2137，`96ed647b`）` cuts; `…/wiki/我，机器人`简介``
 *     does not — the comma there is followed by more title, so the markup is a
 *     separate token.
 *
