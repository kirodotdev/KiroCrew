...
function InteractionPlugin({
  ...
  readOnly,
  sendOnEnter,
}: Pick<LexicalComposerInputProps, 'blocks' | 'onBlocksChange' | 'onChange' | 'onSend' | 'onUploadFiles' | 'sentMessages' | 'onEditLastRequest' | 'disabled' | 'readOnly' | 'sendOnEnter'>) {
  const [editor] = useLexicalComposerContext()
  ...
  }, [disabled, editor, onBlocksChange, onChange, onEditLastRequest, onSend, onUploadFiles, readOnly, sendOnEnter, sentMessages])
