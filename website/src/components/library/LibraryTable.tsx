        ...
        >
          <td className="px-2.5 py-2 border-b border-border text-center">
            <button
              ...
              className={`p-0.5 rounded transition-colors cursor-pointer bg-transparent border-none disabled:cursor-default ${rowConnected ? '' : 'opacity-40 '}${a.pinned ? 'text-accent' : 'text-muted/40 hover:text-accent'}`}
          ...
          <td className="sticky right-0 bg-card px-2.5 py-2 border-b border-border">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                className={`p-1 rounded text-muted hover:text-danger transition-colors cursor-pointer bg-transparent border-none disabled:opacity-60 disabled:cursor-default${rowConnected ? '' : ' opacity-40'}`}
