...
import type { AttachmentSettings, Note, NoteDoc, NotesSettings, SearchHit, SyncResult, Vault } from './types'
...
export const notesApi = {
  ...
  /** The vault's Obsidian attachment folder setting, for `![[embed]]` resolution. */
  listAttachments: (vault: string | null) =>
    mdnbCall<AttachmentSettings>('GET', mdnbVaultQuery('/attachments', vault)),
