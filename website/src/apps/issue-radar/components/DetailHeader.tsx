...
export default function DetailHeader({
  ...
  return (
    <>
      ...
      {back && (
        <div className="sticky top-0 z-20 bg-bg flex items-center gap-2 px-6 min-h-11">
          {back}
      ...
      <div ref={titleRef} data-testid="detail-title-block" className="px-6 pt-4 pb-3 sm:pt-5 sm:pb-0">
      ...
      {/* Row 2: the toolbar. `top-11` so it pins UNDER row 1 rather than over it
          ...
          to opposite edges. */}
      <header className="sticky sm:static top-11 sm:top-auto z-10 bg-bg border-b border-border px-6 py-2 sm:pt-4 sm:pb-4">
