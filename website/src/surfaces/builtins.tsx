 ...
 */
import { MessageSquare, Bell, Component, CalendarDays, Settings, ClipboardCheck, Compass, Webhook, Users, BookOpen, Link2, Library, MessageSquareText, Workflow, ScrollText, Bot, GitBranch } from 'lucide-react'
...
const CAPABILITY_SUB_ITEMS: readonly { tab: string; labelKey: string; label: string; icon: ReactElement }[] = [
  ...
  { tab: 'organization', labelKey: 'organization.title', label: surfaceMachineValue('Org Chart and Guardrails'), icon: <GitBranch className="lucide-inline" /> },
