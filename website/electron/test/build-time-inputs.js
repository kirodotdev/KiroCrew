...
// not contain: build-desktop.sh stages them on demand before packaging and the EXIT
...
module.exports = { BUILD_TIME_INPUTS: new Set(["EXTERNALLY-MANAGED", "edition-loading.html"]) };
