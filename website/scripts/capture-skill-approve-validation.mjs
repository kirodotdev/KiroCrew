...
try {
  ...
  await page
    .getByText('Approval failed: this candidate is no longer pending.', { exact: true })
    .first()
    .waitFor()
  await page.getByText('auto/rotate-staging-fixtures').first().waitFor({ state: 'detached' })
