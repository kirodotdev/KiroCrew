...
async function newPage(
  theme,
  { ignored = false, width = 520, conflict = false, reloadFails = false, active = true } = {},
) {
  ...
  await page.goto(`${BASE}/capture/autonudge-redaction.html?theme=${theme}&w=${width}${activeParam}`)
