...
// The retry affordance mid-request. `retryBusy` is what the page sets while a retry is in
// flight, and it is the only state in which the button renders disabled.
const retryBusy = scope === 'retrying'
  ...
  return (
    <div data-capture-root className="bg-bg text-text p-5 w-[720px] flex flex-col gap-3">
      ...
      <div data-capture-notice className="min-h-[1px]">
        {done && (
          <p role="status" className="text-[12px] text-muted mb-2" data-testid="clear-context-done">
