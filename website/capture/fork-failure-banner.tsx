...
//
// Plain 'offsite' for BOTH rendered the grid's copy in the sidebar's frame.
const offsiteSurface =
  scene === 'sidebar-duplicate' ? 'offsite-compact' : scene === 'grid-pane' ? 'offsite' : 'transcript'
// Both offsite spellings quote the session, so a titleless scene renders a bare "".
const sourceTitle = offsiteSurface === 'transcript' ? undefined : 'A long conversation'
