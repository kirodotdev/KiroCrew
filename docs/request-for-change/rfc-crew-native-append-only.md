...
append, published views, teardown), whose contract ships with the protocol
itself; and a converter that installs configuration-only plugin bundles as apps,
whose contract ships with the converter.
