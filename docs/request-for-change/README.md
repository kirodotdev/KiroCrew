...
row was added later and verified separately against `caa0dca7`; the
`rfc-sel-external-checkpoint` row was added later still and verified against
`429cbad8`; the other twelve rows have not been re-audited since 2026-08-03.
...
| [rfc-sel-external-checkpoint.md](rfc-sel-external-checkpoint.md) | `draft` | Nothing yet — proposal only, no implementation PRs opened |
