...
| [rfc-terminal-session-ownership.md](rfc-terminal-session-ownership.md) | `draft` | Nothing on main. Phase 1 is proposed in [#8863](https://github.com/kirodotdev/KiroCrew/pull/8863): terminal routes become dashboard-owner-only, displaced handlers are fenced and audited, and reconnect replay is bounded. Live terminal IDs still cross windows through `localStorage`; rotating per-tab credentials and explicit popout transfer remain Phase 2 |
