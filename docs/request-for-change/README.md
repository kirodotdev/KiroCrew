...
| [rfc-crew-projects.md](rfc-crew-projects.md) | `in-progress` | Nothing on main. The active branch implements the v1 bundle kernel, managed Git transport, trusted capability materialization, Project-attached sessions, and the Agent Capabilities portal |
