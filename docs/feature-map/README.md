...
| Knowledge | The document library: sources (local files/folders + Bedrock KB live retrieval), sync, entities, graph | `?tab=knowledge` | `pages/knowledge/index.tsx` | `handlers/knowledge.py` | `GET /api/knowledge/items`, `POST /api/knowledge/sources`, `GET /api/knowledge/graph`, `GET /api/knowledge/search-for-context` |
