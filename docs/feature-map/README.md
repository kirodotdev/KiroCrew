...
| Knowledge | The document library: sources, sync, entities, graph; pool effort settings | `?tab=knowledge` | `pages/knowledge/index.tsx`, `pages/knowledge/SettingsTab.tsx` | `handlers/knowledge.py`, `handlers/core.py` | `GET /api/knowledge/items`, `POST /api/knowledge/sources`, `GET /api/knowledge/graph`, `GET,PATCH /api/config/kirocrew` |
