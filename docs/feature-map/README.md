...
| Files in chat | Browse, attach and upload workspace files; search the rail by file NAME or by file CONTENTS, including the text inside Word/PowerPoint/Excel documents | Chat right panel → Files tab, Name/Content toggle below the search field; composer attach | `pages/chat/FileBrowserRail.tsx`, `pages/chat/FilesHomePanel.tsx`, `api/fileGrep.ts` | `handlers/files.py` | `GET /api/file-read`, `POST /api/file-grep`, `POST /api/upload`, `POST /api/upload/file` |
...
| Notifications | Bell feed of agent-pushed notifications | Topbar bell → `/notifications` | `pages/NotificationsPage.tsx` | `handlers/messaging.py`, `handlers/notifications_push.py` | `GET /api/notifications`, `POST /api/notifications/ack`, `POST /api/notifications/push`, `GET /api/notifications/push/vapid-public-key`, `POST /api/notifications/push/subscribe`, `POST /api/notifications/push/unsubscribe` |
...
| `notifications` | Which events notify, on which channel, and this device's Web Push subscription | `NotificationsPanel.tsx` | `handlers/messaging.py`, `handlers/notifications_push.py` | `GET /api/notifications/channels`, `PUT /api/notifications/channels/settings`, `GET /api/notifications/push/vapid-public-key`, `POST /api/notifications/push/subscribe`, `POST /api/notifications/push/unsubscribe` |
