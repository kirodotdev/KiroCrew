...
<| `config` | Raw Kiro Crew and agent config editors | `pages/overview/KiroCrewCfgTab.tsx`, `AgentCfgTab.tsx`, `components/RestartButton.tsx` | `handlers/core.py`, `handlers/agents.py`, `handlers/sessions.py` | `GET,PUT,PATCH /api/config/kirocrew`, `GET,PUT /api/agent/config`, `POST /api/sessions/restart` |
