...
| Section markers | A labelled rule marking where one unit of work ended | Inline rule in the transcript | `pages/chat/SectionMarkerRow.tsx` | `handlers/sessions.py`, `session_directive_apply.py` | `POST /api/session-directive` |
