...
```json
{
  ...
  "responsibilities": [
    ...
    },
    {
      ...
      "concrete_dependency": "merged connections.md, its credential-boundary section; account_binding_ref defined in the manifest as 'never a raw credential'. The #9992 interface is NOT assumed (its diff is unread); a missing binding interface is reported as a named gap, never invented",
