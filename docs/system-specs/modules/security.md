...
- Sensitive paths: `~/.aws`, `~/.ssh`, `~/.gnupg`, `~/.gpg`, `~/.config/gcloud`, `~/.azure`, `~/.docker/config.json`, `~/.kube/config`, `~/.npmrc`, `~/.pypirc`, `~/.netrc`, `~/.git-credentials`, `~/.kirocrew/.env`, `~/.kirocrew/sel_hmac.key`, `~/.kirocrew/security_events.jsonl`, `~/.kirocrew/app_admission.json`, `~/.kirocrew/run`
