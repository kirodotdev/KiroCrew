...
| [devcontainers.md](devcontainers.md) | Running a session's agent inside the project's Dev Container: the trust store, the closed screen, container lifecycle, and exec plumbing. Product contract: [devcontainer-product-readiness](../../design/devcontainer-product-readiness.md). |
