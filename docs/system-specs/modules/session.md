...
callers are, and the two mistakes do not cost the same: a missed cancel leaves a bounded
child running to its own timeout, while a wrong cancel destroys live work for a
conversation that resumes on the next turn.
