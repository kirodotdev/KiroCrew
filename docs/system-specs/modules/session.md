...
name the real recovery surfaces: wait for attached work to settle, or use the
direct Stop control before retrying. Callback transfer and discard are mutually
exclusive, so no completion can settle twice.
