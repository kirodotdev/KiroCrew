...
- **The in-startup population is bounded separately from both the cap and the
  ...
  announce -- and because such a start was never recorded, its tombstone
