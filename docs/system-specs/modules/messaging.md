...
wired up later cannot be covered by a behavioural test written now. A refused re-render
owes no record, exactly as a refused grow does not: those messages have not left the
queue.
