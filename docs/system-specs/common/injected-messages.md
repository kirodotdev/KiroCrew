...
Two adjacent variants exist for a gateway restart, same prefix. These notices
omit usage because an interrupted run has no settled terminal billing record:
