...
- [Near-production opt-in plan](architecture/design-notes/devcontainer-product-readiness.md) — Docker Desktop, dual MCP transport, auth copy, one-file agent inject, and what is still not a prod default.
